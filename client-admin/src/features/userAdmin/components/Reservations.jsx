            ...
            >
              <div className='px-5 pt-5 pb-4 border-b border-gray-100'>
                <div className='flex items-start justify-between gap-3'>
                  <h2 className='text-lg font-bold text-main-blue leading-tight'>
                    {reservation.fieldId?.fieldName ?? 'Cancha'}
                  </h2>
                  <span
              ...
              <div className='px-5 pb-5 mt-auto'>
                {canConfirm ? (
                  <button
                    ...
                    className='w-full py-2.5 rounded-lg bg-main-blue text-white font-medium hover:opacity-90 transition'
                  >
                    Confirmar
                  </button>
                ) : (
