                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg text-xs font-semibold text-white transition ${isCurrentUser
                            ...
                            <div key={user.id} className="p-4 flex flex-col gap-3">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <button
                                        onClick={() => handleChangeRole(user)}
                                        disabled={loading || isCurrentUser}
                                        className={`px-3 py-1.5 rounded-lg text-xs font-semibold text-white ${isCurrentUser
                                                ? "bg-gray-400"
                                                : "bg-blue-600"
                                            }`}
                                    >
